...
homepage := Some(url("https://github.com/edadma/angular-blog"))

pomExtra := (
  <scm>
    <url>git@github.com:edadma/angular-blog.git</url>
    <connection>scm:git:git@github.com:edadma/angular-blog.git</connection>
  </scm>
  <developers>
    <developer>
      <id>edadma</id>
